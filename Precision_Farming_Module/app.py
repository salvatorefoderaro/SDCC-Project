...
TIC = False                             # Flag estabilishing either today's plan has already been computed or not.
...
def planning():
    ...
    if request.method == 'POST':
        ...
        WATER_CONTAINER = request.args.get("water_container_volume")
        ...
        group_list = request.args.get("groups_list")
        ...
        for polygon in POLYGONS_INFOS:
            ...
            polygon.evaluate_water_unit_coefficient()
            polygon.set_water_unit( water_unit * polygon.water_unit_coefficient )
        ...
        return 'You are a culetto with outreageous tettariellies'
